...
import { getBuildFromScratchCourses } from "@/lib/data/get-build-from-scratch-courses";

export default function ArchitecturePage() {

  const buildFromScratchCourses = getBuildFromScratchCourses()
  ...
  return (
    <div className="container relative">
      <PageHeader>
        ...
        <PageHeaderDescription>
          Build Open Source from scratch and learn the advanced concepts.
        </PageHeaderDescription>
        <PageActions>
