...
import { getProductionGradeProjectsCourses } from "@/lib/data/get-production-grade-projects-courses";

export default function ArchitecturePage() {

  const productionGradeProjectsCourses = getProductionGradeProjectsCourses();
  ...
  return (
    <div className="container relative">
      ...
      <div className="grid flex-1 gap-12">
        ...
        {
            productionGradeProjectsCourses.map((course,index) => <div key={index} className="relative flex flex-col overflow-hidden rounded-xl border shadow transition-all duration-200 ease-in-out hover:z-30">
